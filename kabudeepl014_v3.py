...
#alg0 = "ExtraTreeClassifier"
alg0 = "AdaBoostClassifier"
#alg0 = "BernoulliNB"
#alg0 = "CalibratedClassifierCV" ×
#alg0 = "DecisionTreeClassifier"
#alg0 = "RidgeClassifierCV" ×
#alg0 = "CheckingClassifier" ×
#alg0 = "GaussianNB" ×
#alg0 = "GaussianProcessClassifier" ×
#alg0 = "GradientBoostingClassifier"
#alg0 = "LabelPropagation" ×
#alg0 = "RidgeClassifierCV" ×
#alg0 = "Perceptron" ×
#alg0 = "VotingClassifier" ×
#alg0 = "MultiOutputClassifier" ×
#alg0 = "LinearDiscriminantAnalysis"
#alg0 = "PassiveAggressiveClassifier" ×
#alg0 = "QuadraticDiscriminantAnalysis"
...
conn.commit()
print("処理終了",alg0,"lank6:",cnt6,"lank5:",cnt5,"lank4:",cnt4,"lank3:",cnt3,"lank2:",cnt2,"lank1:",cnt1)
dt_now = datetime.datetime.now()
